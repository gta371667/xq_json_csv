...
const List<dynamic> singleRow = [1, 'a', 2, 'aabb', 'c\nd', 3, 'e",f', 4, "g',h", 5.6];
...
const String csvSingleRowCommaDelimitAll = '"1","a","2","aabb","c\nd","3","e"",f","4","g\',h","5.6"';
...
const List<List> multipleRows = [titleRow, singleRow, singleRow, singleRow];

const String csvSimpleStringsSingleRowComma = 'a,b';
const List simpleStringsSingleRow = ['a', 'b'];

const List singleRowAllText = ['1', 'a', '2', 'aabb', 'c\nd', '3', 'e",f', '4', "g',h", '5.6'];
const List singleRowNoDouble = [1, 'a', 2, 'aabb', 'c\nd', 3, 'e",f', 4, "g',h", '5.6'];

const List<List> multipleRowsAllText = [singleRowAllText, singleRowAllText, singleRowAllText];
const List<List> multipleRowsNoDouble = [singleRowNoDouble, singleRowNoDouble, singleRowNoDouble];
...
// eol: _xyz
const List<String> csvComplex3_parts = ['.,a,b,_', 'xy', 'z.,a,b,_', '__', 'xyz.,a,b,', '___xyz,.', ',a,b,_'];
...
const List<String> autodetectCsv_parts = ['ab', 'c,2', ',\n"', '"3,«', '«,\'\r', '\n!,\'\n'];
